...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03-Jun-2022 às 16:13
...
--
-- Banco de dados: `dbpython`
--
CREATE DATABASE IF NOT EXISTS `dbpython` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dbpython`;
...
INSERT INTO `vendas` (`id_vendas`, `nome_produto`, `nome_cliente`, `valor`, `data_compra`) VALUES
(1, 'nescal', 'marcos', 2, '10/05/2022'),
(3, 'leite', 'joão', 5, '18/02/2020'),
(4, 'toddy', 'antonio', 2.55, '10/08/2021'),
(5, 'café', 'ricardo', 2.85, '18/08/2022'),
(6, 'açucar', 'vinicius', 3.9, '10/08/2022'),
(7, 'biscoito', 'rogerio', 2.5, '18/02/2022'),
(8, 'amendoim', 'junior', 10.25, '18/06/2022'),
(9, 'chiclete', 'davi', 1.25, '03/06/2022');
...
--
ALTER TABLE `vendas`
  MODIFY `id_vendas` int(80) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
('root', 'dbpython', 'vendas', '{\"sorted_col\":\"`vendas`.`nome_produto` DESC\"}', '2022-06-02 17:51:20');
...
('root', '2022-06-03 14:12:27', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
